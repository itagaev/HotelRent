...
export const hotels: Hotel[] = [
  ...
  },
  {
    ...
    name: "Отель Алматы", 
    stars: 3, 
    desc: "Гостиница «Алматы» расположена в центре города Алматы. К услугам гостей ресторан, сауна и массажный кабинет. Стойка регистрации работает круглосуточно. Предоставляется бесплатный Wi-Fi.", 
    rating: 8.5, 
    maxPlace: 3, 
    hasPlace: true,
    price: {
  ...
  },
  {
    ...
    name: "Gokai Hotel", 
    stars: 3, 
    desc: "Отель Gokai расположен в районе Нур-Султан, в 5 км от монумента Байтерек. К услугам гостей бар, бесплатная частная парковка и общий лаундж.", 
    rating: 8.7, 
    maxPlace: 2,  
    hasPlace: true,
    price: {
